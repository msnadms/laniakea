...
- **Mind route risk.** Each routed extractor gains 1 risk per extractor in its galaxy and 0.5 per extractor elsewhere in its supercluster; separate superclusters add none. Risk over 3 adds 1 probe attention on dispatch. One **Signal Dampener** halves an extractor's risk, and two eliminate it.
